    ...
    <div className="space-y-6">
      <Card className="rounded-2xl">
        ...
        <p className="mt-2 max-w-3xl text-sm text-[color:var(--muted-strong)]">
          Selecciona cliente, vehiculo y referencias reales de repuestos o mano de obra. El
          presupuesto queda como borrador editable para seguir completando el flujo de Sprint 2.
        </p>
      </Card>
